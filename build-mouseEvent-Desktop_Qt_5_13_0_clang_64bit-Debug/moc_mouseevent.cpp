...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_mouseEvent_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_mouseEvent_t qt_meta_stringdata_mouseEvent = {
    {
QT_MOC_LITERAL(0, 0, 10) // "mouseEvent"
...
QT_INIT_METAOBJECT const QMetaObject mouseEvent::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_mouseEvent.data,
